...
bool Hero::init()
{
	...
	do {
		...
		this->initWithSpriteFrameName("Down_01.png");

		Animation *pUpAnim = this->createAnimation("Up_%02d.png", 5, 6);
		this->setUpAction(RepeatForever::create(Animate::create(pUpAnim)));
		Animation *pDownAnim = this->createAnimation("Down_%02d.png", 5, 6);
		this->setDownAction(RepeatForever::create(Animate::create(pDownAnim)));
		Animation *pLeftAnim = this->createAnimation("Left_%02d.png",5, 6);
		this->setLeftAction(RepeatForever::create(Animate::create(pLeftAnim)));
		Animation *pRightAnim = this->createAnimation("Right_%02d.png", 5, 6);
		this->setRightAction(RepeatForever::create(Animate::create(pRightAnim)));
		Animation *pMakeSureAnim = this->createAnimation("Left_%02d.png",5,6);
		this->setMakeSureAction(RepeatForever::create(Animate::create(pMakeSureAnim)));
